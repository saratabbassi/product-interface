...
public class Fenetre {
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 if(matricule.getText().equals("") || nom.getText().equals("") || prix.getText().equals("") || comboBox.getSelectedItem().equals("") || designation.getText().equals("")) {
					 JOptionPane.showMessageDialog(null, "Les informations du produit n'est pas compléte");
				 }else
				 {
		...
		panel_2.setBounds(40, 228, 345, 125);
		...
		btnRechercher.setBounds(94, 94, 139, 21);
		panel_2.add(btnRechercher);
		
		textField = new JTextField();
		textField.setEditable(false);
		textField.setColumns(10);
		textField.setBounds(105, 24, 198, 21);
		panel_2.add(textField);
		
		textField_1 = new JTextField();
		textField_1.setEditable(false);
		textField_1.setColumns(10);
		textField_1.setBounds(105, 63, 198, 21);
		panel_2.add(textField_1);
		
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Matricule");
		lblNewLabel_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_1_1_1_1.setBounds(10, 28, 98, 21);
		panel_2.add(lblNewLabel_1_1_1_1);
		
		JLabel lblNewLabel_1_1_1_2 = new JLabel("Nom");
		lblNewLabel_1_1_1_2.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_1_1_1_2.setBounds(10, 63, 98, 21);
		...
		Object[] column = {"Matricule","Nom","Prix","Année Fabrication","Designation"};
